        ...
        <form class="formcadastro" method="POST" action="src/php/cadastrar.php" >
            ...
            <div class="inserts">
                <div class="dados">
                    ...
                    <input type="text" name="apelido" id="apelido" tabindex="1" required autofocus>
                </div>
                <div class="dados">
                    <p><strong>Nome:</strong></p>
                    <input type="text" name="nome" id="nome" tabindex="2" required autofocus>
                </div>
                <div class="dados">
                    <p><strong>E-mail:</strong></p>
                    <input type="email" name="email" id="email" tabindex="3" required autofocus>
                </div>
                <div class="dados">
                    <p><strong>Senha:</strong></p>
                    <input type="password" name="senha" id="senha" tabindex="4" required>
                </div>
                <div class="dados">
                    <p><strong>Confirmar senha:</strong></p>
                    <input type="password" name="conf" id="conf" tabindex="5" required>
                </div>
            </div>
            <div class="buttons">
